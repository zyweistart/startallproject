...
function b_writeStyle() {
	...
	document
			.write('	background:url(images/reddish/013.gif) transparent no-repeat left top;');
	document.write('}');

	document.write('.button Table tr td {');
	document
			.write('    font-size:14px;letter-spacing:1px;font-weight:bold;color:#EE5F7F;FILTER:dropshadow(color=#ffffff, offx=1, offy=1, positive=1);');
