...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#EFE8D8">
 <tbody>
  <tr>
    <td height="30" colspan="2" align="center" bgcolor="#CDB98D"><b>用户登录</b></td>
  </tr>
  <c:if test="${empty stuUser}">
    ...
    <tr>
     <td height="30" colspan="2" align="center"><a href="#" id="issok"><img src="${pageContext.request.contextPath}/index/images/gif-0554.gif" width="45" height="19" border="0"/></a> <a href="${pageContext.request.contextPath}/registration.jsp"><img src="${pageContext.request.contextPath}/index/images/gif-0555.gif" width="45" height="19" border="0"/></a></td>
    </tr>
  </c:if>
