...
<s:form action="visits_list" id="ec">
    <div style="width:100%">
        <%-- 如果有查询条件，请在此补全
        ...
        --%>
        <ec:table items="visitss" var="visits" action="${pageContext.request.contextPath}/visits_list.htm" retrieveRowsCallback="limit" filterRowsCallback="limit" title="">
