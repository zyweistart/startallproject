...
<s:form action="interactive_list" id="ec">
    <div style="width:100%">
        <%-- 如果有查询条件，请在此补全
        ...
        --%>
        <ec:table items="interactives" var="interactive" action="${pageContext.request.contextPath}/interactive_list.htm" retrieveRowsCallback="limit" filterRowsCallback="limit" title="">
