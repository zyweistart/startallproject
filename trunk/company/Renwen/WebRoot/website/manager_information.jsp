...
<s:form action="information_manager" id="ec">
    <s:hidden name="insert" id="insertAction" value="information_showAdd.htm" />
    <s:hidden name="update" id="updateAction" value="information_showEdit.htm" />
    <s:hidden name="delete" id="deleteAction" value="information_delete.htm" />
    <div style="width:100%">
        ...
        <ec:table items="informations" var="information" action="${pageContext.request.contextPath}/information_manager.htm" retrieveRowsCallback="limit" filterRowsCallback="limit"
