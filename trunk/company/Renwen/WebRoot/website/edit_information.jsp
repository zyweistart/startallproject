...
<s:form action="information_save" method="post" validate="true" enctype="multipart/form-data"  id="ec">
    ...
    <s:hidden name="information.hits" />
    <s:hidden name="information.releases" />
    <s:hidden name="information.releaseTime" />
    <s:hidden name="information.releaseUserCode" />
    <s:hidden name="information.releaseUserName" />
    <s:hidden name="information.scalepic" />
    <s:hidden name="information.annexpath" />
    <s:hidden name="information.fileName" />
    <s:hidden name="information.contentType" />
    <s:hidden name="inputPage" value="/website/edit_information.jsp" />
    <table border="0" cellpadding="1" cellspacing="1" width="100%" class="tableBgColor" id="ec">
    <tr>
        ...
        <tr <c:if test="${information.pagetype ne 4 }">style="display:none"</c:if> id="scalepic">
            <td align="right" width="15%" class="leftTdBgColor">
                &nbsp;导引图：
            </td>
            <td align="left" width="85%" class="rightTdBgColor" colspan="3">
        ...
        <c:if test="${not empty information.scalepic }">
        <tr>
            <td align="right" width="15%" class="leftTdBgColor">
                &nbsp;导引图：
            </td>
            <td align="left" width="85%" class="rightTdBgColor" colspan="3">
            	<img src="/imgs/${information.scalepic}" width="215" height="155"/>
            </td>
        </tr>
        </c:if>
        <tr>
        ...
        <tr>
			<td bgcolor="#FFFFFF" colspan="4">
	            ...
	            <c:set value="${information.content}" var="editorValue"></c:set>
