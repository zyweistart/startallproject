...
<s:form action="operator_save" id="operatorForm" method="post" validate="true">
    <s:token />
    <s:hidden name="operator.roles" id="roles" />
    <s:hidden name="inputPage" value="/system/add_operator.jsp" />
    <s:hidden name="operator.code"></s:hidden>
    <table border="0" cellpadding="1" cellspacing="1" width="100%" class="tableBgColor">
        <tr>
            ...
            <td align="left" width="35%" class="rightTdBgColor">
                &nbsp;<s:textfield name="operator.password" cssClass="textInput" cssStyle="width:75%" />
            </td>
        </tr>
        <tr>
         	<td align="right" width="15%" class="leftTdBgColor">
            ...
            <td align="center" class="leftTdBgColor" colspan="4">
             <table border="1" bordercolor="#FFFFFF" bordercolorlight="#000000"
					...
					<tr>
						...
						<td align="center">
							 <select multiple="multiple" name="selectedIds" size="20" style="width: 100%;"></select>
						</td>
					</tr>
				</table>
            </td>
