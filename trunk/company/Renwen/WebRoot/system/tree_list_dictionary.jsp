...
alert("ids:"+ids);
    var url = "${pageContext.request.contextPath}/dictionary_list.htm?dictionary.parentId="+ids;
    var url2 = "${pageContext.request.contextPath}/dictionary_list.htm?pid="+ids;
