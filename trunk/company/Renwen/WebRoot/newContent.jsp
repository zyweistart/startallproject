	...
	<tr>
		...
		<c:if test="${not empty integration.name}">
			...
			<table width="95%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td align="left" class="date">来源：<strong>${integration.newsfrom}</strong>
					&nbsp;&nbsp;&nbsp;&nbsp;时间：<strong>${fn:substring(integration.startDay,0,10)}</strong>&nbsp;&nbsp;&nbsp;&nbsp;浏览量：${integration.hits}</td>
				</tr>
				<tr>
					<td align="left">${integration.content}</td>
				</tr>
				<tr>
					<td class="date">
					  &nbsp;
					<!-- [<a
						href="${pageContext.request.contextPath}/guideIndex.jsp">返回列表</a>][<a
						href="#" onclick="javascript:window.close();">关闭</a>]-->
						</td>
				</tr>
			</table>
		</c:if></td>
