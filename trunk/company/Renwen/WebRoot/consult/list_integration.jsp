...
<s:form action="integration_list" id="ec">
    <div style="width:100%">
        <%-- 如果有查询条件，请在此补全
        ...
        --%>
        <ec:table items="integrations" var="integration" action="${pageContext.request.contextPath}/integration_list.htm" retrieveRowsCallback="limit" filterRowsCallback="limit" title="">
