 ...
 */
package com.hightern.fckeditor.localization;
...
public class LocalizedMessages {
	...
	/**
	 * Returns an instance of <code>LocalizedMessages</code> for a given request. This method automatically determines the locale of this request and loads the appropriate bundle. If locale is null
	 * or not available, the default locale will be used.
	 * 
	 * @param request
	...
	private LocalizedMessages(Locale locale) {
		...
		properties = new Properties(LocalizedMessages.defaultProperties);
		...
		if (localized != null && localized.getLocale().getLanguage().equals(locale.getLanguage())) {
			...
			try {
				base = ResourceBundle.getBundle(LocalizedMessages.LOCAL_PROPERTIES, LocalizedMessages.NEUTRAL, Thread.currentThread()
