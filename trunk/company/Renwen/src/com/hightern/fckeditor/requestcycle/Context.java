 ...
 */
package com.hightern.fckeditor.requestcycle;
...
import com.hightern.fckeditor.connector.Dispatcher;
...
public class Context {
	...
	public void logBaseParameters() {
		Context.logger.debug("Parameter Command: {}", commandStr);
		Context.logger.debug("Parameter Type: {}", typeStr);
		Context.logger.debug("Parameter CurrentFolder: {}", currentFolderStr);
	}
