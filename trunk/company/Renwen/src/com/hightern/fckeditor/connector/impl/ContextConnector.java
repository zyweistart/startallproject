...
import com.hightern.fckeditor.requestcycle.impl.ContextPathBuilder;
...
public class ContextConnector extends AbstractLocalFileSystemConnector {
	 ...
	 * target="_blank">ServletContext.getRealPath(String)</a></code>
	 * against the local filesystem (real path). If it fails, it will emit helpful log messages and will throw an exception too.
	 */
	public void init(final ServletContext servletContext) throws Exception {
		this.servletContext = servletContext;
		final String defaultAbsolutePath = getRealUserFilesAbsolutePath(PropertiesLoader.getUserFilesPath());
