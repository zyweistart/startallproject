...
/**
 * Java representation of the <a href="http://docs.fckeditor.net/FCKeditor_2.x/Developers_Guide/Configuration/Configuration_Options" target="_blank">FCKConfig</a> object from the editor. Every
 * FCKeditor instance will load the <code>config.js</code> by default, if you assign a FCKConfig instance to an editor, it will automatically override these system-wide settings for the current
 * instance only.
 * 
