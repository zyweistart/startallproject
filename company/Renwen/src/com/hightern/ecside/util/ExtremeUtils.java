...
public final class ExtremeUtils {
    ...
    public static String formatDate(String parse, String format, Object value,
        ...
        if (StringUtils.isBlank(format)) {
            ...
            logger.error("The format was not defined for date ["
                    + valueAsString + "].");
        ...
        if (value instanceof Date) {
            ...
            if (StringUtils.isBlank(parse)) {
                logger.error("The parse was not defined for date String ["
                        + valueAsString + "].");
                return valueAsString;
            }
            ...
            try {
                ...
                logger.error("The parse was incorrectly defined for date String ["
                        + valueAsString + "].");
                return valueAsString;
            }
        }
    ...
    public static String formatNumber(String format, Object value, Locale locale) {
        ...
        if (StringUtils.isBlank(format)) {
            logger.error("The format was not defined for number ["
                    + value.toString() + "].");
    ...
    public static Object retrieveFromScope(PageContext pageContext,
    ...
    public static int sessionSize(HttpSession session) {
        ...
        try {
            ...
            while (enumeration.hasMoreElements()) {
                ...
                int size = baos.size();
                total += size;
                logger.debug("The session name: " + name + " and the size is: "
                        + size);
            }
    ...
    @SuppressWarnings("unchecked")
    public static List checkboxesSelected(HttpServletRequest request,
        ...
        while (parameterNames.hasMoreElements()) {
            ...
            if (parameterName.startsWith(startsWithValue)) {
                results.add(StringUtils.substringAfter(parameterName,
                        startsWithValue));
            }
        }
