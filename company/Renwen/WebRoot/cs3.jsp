...
<body onLoad="MM_preloadImages('${pageContext.request.contextPath}/index/images/fh1.gif')">
  ...
  <tr>
    ...
    <td colspan="2" valign="top"><table width="100%" height="100" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="55" align="left"><img src="${pageContext.request.contextPath}/index/images/menu_1.png" width="35" height="100"></td>
        <td width="55" align="left"><img src="${pageContext.request.contextPath}/index/images/menu_2.png" width="35" height="100"></td>
        <td width="55" align="left"><img src="${pageContext.request.contextPath}/index/images/menu_3.png" width="35" height="100"></td>
        <td width="55" align="left"><img src="${pageContext.request.contextPath}/index/images/menu_4.png" width="35" height="100"></td>
        <td width="55" align="left"><img src="${pageContext.request.contextPath}/index/images/menu_5.png" width="35" height="100"></td>
        <td width="55" align="left"><a href="${pageContext.request.contextPath}/integration_list_home.htm?id=20&typeId=20"><img src="${pageContext.request.contextPath}/index/images/menu_6.png" width="35" height="100" border="0"></a></td>
        <td>&nbsp;</td>
      </tr>
    </table></td>
  </tr>
  <tr>
      ...
      <tr>
        ...
        <td width="370" align="left" valign="top">
		 <c:forEach var="n" items="${integrations}">
		  <div id="list_1">
		   <div class="t"><a href="${pageContext.request.contextPath}/integration_content.htm?id=${n.id}&typeId=${typeId}" target="_blank">${n.name}</a></div>
	...
	<c:if test="${not empty integrations}">
        ...
        <td align="center" valign="top"><img src="${pageContext.request.contextPath}/index/images/t_1.png" width="50" height="201"></td>
      </tr>
    </table></td>
    <td height="400" align="center" valign="top"> 
    <c:forEach items="${newstypes}" var="n">
	<div class="btn_1"><c:if test="${empty n.ljUrl}">
						<a
