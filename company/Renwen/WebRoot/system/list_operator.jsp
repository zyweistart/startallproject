...
<s:form action="operator_list" id="ec">
    <div style="width:100%">
      <table border="0" cellpadding="0" cellspacing="0" width="100%" class="talbe_gray_border">
        ...
        <ec:table items="operators" var="operator" action="${pageContext.request.contextPath}/operator_list.htm" retrieveRowsCallback="limit" filterRowsCallback="limit" title="">
