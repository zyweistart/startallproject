...
<s:form action="newstype_list" id="ec">
    <div style="width:100%">
        <%-- 如果有查询条件，请在此补全
        ...
        --%>
        <ec:table items="newstypes" var="newstype" action="${pageContext.request.contextPath}/newstype_list.htm" retrieveRowsCallback="limit" filterRowsCallback="limit" title="">
