...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/consult/tree_newstype.js"></script>
    ...
    <div style="overflow: auto">
        <script language="JavaScript">
            ...
            if(document.getElementById) {
				...
				treeitem[j++] =  new WebFXTreeItem('${newstype.id}','${newstype.pid}',"${newstype.name}");
