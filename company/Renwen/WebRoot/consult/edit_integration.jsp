...
<s:form action="integration_save" method="post" validate="true" enctype="multipart/form-data">
    <s:token />
    ...
    <s:hidden name="inputPage" value="/consult/edit_integration.jsp" />
      ...
      <tr>
        <td align="right" width="15%" class="leftTdBgColor">
            ...
            <td align="left" width="35%" class="rightTdBgColor">
				...
				<s:textfield readonly="true" name="integration.newsTypeName"
					cssStyle="width:25%" cssClass="textInput" id="parentName"></s:textfield>
       ...
       <tr>
        ...
        <tr>
			...
			<td align="left" width="35%" class="rightTdBgColor"  display:none">
               &nbsp;<s:radio list="#{0:'无',1:'1号区域',2:'2号区域',3:'3号区域',4:'4号区域' }" name="integration.xcrj"  value="%{integration.xcrj}"></s:radio>
			</td>
			</tr>
        <tr style="display:none;">
            <td align="right" width="15%" class="leftTdBgColor">
        ...
        <tr style="display:none">
          <td align="right" width="15%" class="leftTdBgColor" >
            ...
            <td align="left" width="35%" class="rightTdBgColor"  >
                &nbsp;<s:radio list="#{0:'否',99:'是'}" name="integration.tzStart"  value="%{integration.tzStart}"></s:radio>
            </td>
        </tr>
        <tr>
         ...
         <tr style="height: 400px;">
            ...
            <c:set value="${integration.content}" var="editorValue"></c:set>
