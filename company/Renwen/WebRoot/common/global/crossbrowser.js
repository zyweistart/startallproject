function browserType() {
	...
	this.op5 = (this.name.indexOf("Opera") > -1 && (this.dom)) ? 1 : 0 // Opera
	this.ie4 = (document.all && !this.dom) ? 1 : 0 // ie4
	this.ie5 = (this.dom && this.version.indexOf("MSIE ") > -1) ? 1 : 0 // IE5,
	this.ns4 = (document.layers && !this.dom) ? 1 : 0 // NS4
	this.ns5 = (this.dom && this.version.indexOf("MSIE ") == -1) ? 1 : 0 // NS6,
	...
	this.ok = (this.ie4 || this.ie5 || this.ns4 || this.ns5 || this.op5) // any
	eval("bt=this");
}
browserType();
...
function getObj(obj) {
	...
	return (bt.dom) ? document.getElementById(obj) : (bt.ie4)
			? document.all[obj]
			: (bt.ns4) ? getRefNS4(document, obj) : 0
}

function createPageSize() {
	this.width = (bt.ns4 || bt.ns5 || bt.op5)
			? innerWidth
			: document.body.offsetWidth;
	this.height = (bt.ns4 || bt.ns5 || bt.op5)
			? innerHeight
...
var globalObj = null;
function remindState(obj) {
	if (globalObj != null)
		globalObj.className = "unSelected";
