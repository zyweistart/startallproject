								...
								<table width="100%" height="41" border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td width="600" class="title_1">
											人文学院<font class="title_menu">师生互动</font>
										</td>
										<td align="center">&nbsp;</td>
									</tr>
								</table>
										...
										<table width="95%" border="0" cellpadding="1" cellspacing="1" class="tableBgColor">
											<tr align="center">
												...
												<td align="left" class="rightTdBgColor">
												   <s:textfield name="name"  id="name" cssStyle="width:350px" /><Br>
											...
											<tr align="center">
											   ...
											   <td align="left" class="rightTdBgColor">
											    <s:textfield name="contact" id="contact" cssStyle="width:350px" /><br>
											...
											<tr align="center">
											   ...
											   <td align="left" class="rightTdBgColor">
											    <s:textfield name="email" id="email" cssStyle="width:350px" /><br>
											   </td>
											</tr>
											<tr align="center">
											...
											<tr align="center">
											   <td align="center" colspan="2" class="rightTdBgColor">
